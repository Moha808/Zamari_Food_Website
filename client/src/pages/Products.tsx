...
export default function Products() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: "₦3,000",
      description:
        "A blend of beetroot and spices for natural energy and vitality.",
      longDescription:
    ...
    },
    {
      ...
      price: "₦3,000",
      description:
        "A herbal tea infused with black seed for immunity and wellness.",
      longDescription:
    ...
    },
    {
      ...
      price: "₦3,000",
      description:
        "A calming herbal tea ideal for stress relief and relaxation.",
      longDescription:
